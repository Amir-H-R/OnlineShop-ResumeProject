            ...
            modelBuilder.Entity("Domain.Entities.Users_n_Roles.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1L,
                            CreateDate = new DateTime(2022, 2, 4, 12, 47, 22, 628, DateTimeKind.Local).AddTicks(5140),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            RoleId = 2L,
                            CreateDate = new DateTime(2022, 2, 4, 12, 47, 22, 628, DateTimeKind.Local).AddTicks(5303),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            RoleId = 3L,
                            CreateDate = new DateTime(2022, 2, 4, 12, 47, 22, 628, DateTimeKind.Local).AddTicks(5317),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
