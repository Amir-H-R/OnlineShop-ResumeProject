...
namespace Persistence.Migrations
{
    ...
    [Migration("20211223193854_RemoveQueryFilter")]
            ...
            modelBuilder.Entity("Domain.Entities.Users_n_Roles.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1L,
                            CreateDate = new DateTime(2021, 12, 23, 23, 8, 53, 829, DateTimeKind.Local).AddTicks(7744),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            RoleId = 2L,
                            CreateDate = new DateTime(2021, 12, 23, 23, 8, 53, 829, DateTimeKind.Local).AddTicks(7784),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            RoleId = 3L,
                            CreateDate = new DateTime(2021, 12, 23, 23, 8, 53, 829, DateTimeKind.Local).AddTicks(7799),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
