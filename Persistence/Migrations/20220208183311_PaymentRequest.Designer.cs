...
namespace Persistence.Migrations
{
    ...
    [Migration("20220208183311_PaymentRequest")]
            ...
            modelBuilder.Entity("Domain.Entities.Users_n_Roles.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1L,
                            CreateDate = new DateTime(2022, 2, 8, 22, 3, 10, 661, DateTimeKind.Local).AddTicks(1639),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            RoleId = 2L,
                            CreateDate = new DateTime(2022, 2, 8, 22, 3, 10, 661, DateTimeKind.Local).AddTicks(1681),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            RoleId = 3L,
                            CreateDate = new DateTime(2022, 2, 8, 22, 3, 10, 661, DateTimeKind.Local).AddTicks(1696),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
