...
namespace Persistence.Migrations
{
    ...
    [Migration("20211227104009_UserRolesBugFix")]
    partial class UserRolesBugFix
    {
            ...
            modelBuilder.Entity("Domain.Entities.Users_n_Roles.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1L,
                            CreateDate = new DateTime(2021, 12, 27, 14, 10, 8, 651, DateTimeKind.Local).AddTicks(3674),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            RoleId = 2L,
                            CreateDate = new DateTime(2021, 12, 27, 14, 10, 8, 651, DateTimeKind.Local).AddTicks(3706),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            RoleId = 3L,
                            CreateDate = new DateTime(2021, 12, 27, 14, 10, 8, 651, DateTimeKind.Local).AddTicks(3719),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
