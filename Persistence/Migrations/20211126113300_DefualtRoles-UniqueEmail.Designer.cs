...
namespace Persistence.Migrations
{
    ...
    [Migration("20211126113300_DefualtRoles-UniqueEmail")]
    partial class DefualtRolesUniqueEmail
    {
            ...
            modelBuilder.Entity("Domain.Entities.Users_n_Roles.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1L,
                            CreateDate = new DateTime(2021, 11, 26, 15, 3, 0, 213, DateTimeKind.Local).AddTicks(2379),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            RoleId = 2L,
                            CreateDate = new DateTime(2021, 11, 26, 15, 3, 0, 213, DateTimeKind.Local).AddTicks(2410),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            RoleId = 3L,
                            CreateDate = new DateTime(2021, 11, 26, 15, 3, 0, 213, DateTimeKind.Local).AddTicks(2422),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
